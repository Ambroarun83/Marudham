...
$update = $connect->query("UPDATE `gold_info` SET `cus_id`='$cus_id',`req_id`='$req_id',`gold_sts`='$gold_sts',`gold_type`='$gold_type',`Purity`='$Purity',`gold_Count`='$gold_Count',`gold_Weight`='$gold_Weight',`gold_Value`='$gold_Value' WHERE `id`='$goldID' ");
