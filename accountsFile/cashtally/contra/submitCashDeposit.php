...
if($qry->num_rows == 0){
    ...
    $qry = $con->query("INSERT INTO `ct_cr_cash_deposit`( `db_ref_id`, `ref_code`, `trans_id`, `remark`, `insert_login_id`, `created_date`) 
        VALUES ('$bdep_id','$ref_code','$trans_id','$remark','$user_id',now())");
