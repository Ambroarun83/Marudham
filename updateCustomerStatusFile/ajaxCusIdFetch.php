...
$qry = $connect->query("SELECT cp.req_id as cp_req_id FROM acknowlegement_customer_profile cp JOIN in_issue ii ON cp.req_id = ii.req_id where ii.status = 0 and (ii.cus_status >= 14 and ii.cus_status <= 17) LIMIT 270, 10000");
