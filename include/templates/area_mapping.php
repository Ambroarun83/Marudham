                ...
                <div class="row">
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
						<div class="form-group" style="text-align:center">
							...
							<input type="radio" name="mapping_type" id="line" value="line" <?php if(isset($due_method) and $due_method == 'line') echo 'checked';?>></input><label for='line' >&nbsp;&nbsp;Line</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="mapping_type" id="group" value="group" <?php if(isset($due_method) and $due_method == 'group') echo 'checked';?>></input><label for='group'>&nbsp;&nbsp;Group</label>
						</div>
					</div> -->
				</div>
