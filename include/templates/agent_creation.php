							...
							<div class="col-md-12 "> 
								...
								<table id="moduleTable" class="table custom-table">
									<thead>
										...
										if(isset($name)){ ?>
											<tbody>
												<?php $tb = 9;for($i=0; $i<=sizeof($name)-1; $i++) { ?>
													<tr>
														<td>
															<input type="text" tabindex="<?php $tb++;echo $tb;?>" name="name[]" id="name" class="form-control" value="<?php if(isset($name)){ echo $name[$i]; } ?>" pattern="[a-zA-Z\s]+">
														</td>
														<td>
														...
														<td>
															<span class='icon-trash-2' tabindex="<?php $tb++;echo $tb;?>" <?php if($i>0){echo "id='deleterow'";} ?>></span>
														</td>
													</tr>
												<?php } ?>
											</tbody>
