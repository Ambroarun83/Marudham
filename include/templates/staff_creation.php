								...
								<div class="row">
									...
									<div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-12" style="margin-top: 19px;">
                                        <div class="form-group float-right">
                                            <button type="button" tabindex="4" class="btn btn-primary" id="add_staff_type" name="add_staff_type" data-toggle="modal" data-target=".addStaffType" style="padding: 5px 35px;" ><span class="icon-add"></span></button>
                                        </div>
                                    </div>
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="col-xl-2 col-lg-2 col-md-6 col-sm-4 col-12">
						<label class="label" style="visibility:hidden">Enter Staff Type</label>
