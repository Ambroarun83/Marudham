								...
								<div class="row">
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-8">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="mobile" name="mobile" value='<?php if (isset($mobile)) {echo $mobile;} ?>' readonly tabindex='8'>
										</div>
									</div>
						...
						<div class="row">
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-8">
								<div class="form-group">
									...
									onclick="event.preventDefault()" title='Put Your Thumb' tabindex='43'><i class="material-icons" id="icon-flipped" >&#xe90d;</i>&nbsp;Scan</button>
