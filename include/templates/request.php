...
if($idupd>0)
{
	...
	if (sizeof($getRequest)>0) {
        for($i=0;$i<sizeof($getRequest);$i++)  {			
			...
			if($user_type == 'Director'){$role='1';}else
			if($user_type == 'Agent'){$role='2';}else
			if($user_type == 'Staff'){$role='3';}
	...
	if (sizeof($getUser)>0) {
		for($i=0;$i<sizeof($getUser);$i++)  {			
			...
			$role          		     = $getUser['role'];
			if($role == '1'){$user_type='Director';}else
			if($role == '2'){$user_type='Agent';}else
			if($role == '3'){$user_type='Staff';}
						...
						<div class="card-body">
							<div class="row">
								<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
									...
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 agent" <?php if(isset($role)){ if($role == '2') {?>style="display: none" <?php } } ?>>
										<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-8">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="address" name="address" value='<?php if(isset($address)) {echo $address;} ?>' tabindex='21' placeholder="Enter Address" >
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-8">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="mobile1" name="mobile1" onkeypress="if(this.value.length==10) return false;" value='<?php if(isset($mobile1)) {echo $mobile1;} ?>' tabindex='22' placeholder="Enter Mobile Number">
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-8">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="mobile2" name="mobile2" onkeypress="if(this.value.length==10) return false;" value='<?php if(isset($mobile2)) {echo $mobile2;} ?>' tabindex='23' placeholder="Enter Mobile Number">
										</div>
									</div>
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-8">
										<div class="form-group">
