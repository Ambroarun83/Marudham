...
//NOC may completed, now remove = 22.
    ...
    $selectIC = $con->query("UPDATE `in_acknowledgement` SET `cus_status`= 22,`update_login_id`= $userid WHERE  cus_id = '".$cus_id."' and req_id = '".$req_id."' ") or die('Error on in_acknowledgement Table');
