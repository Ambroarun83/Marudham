...
class verificaitonClass
{
    ...
    function getverificaitonCounts($con)
    {
        ...
        $today_in_ver = "SELECT COUNT(*) as tot_in_ver from request_creation where cus_status = 1 and date(updated_date) = '$today' ";
        ...
        $tot_new = "SELECT COUNT(*) as tot_new from request_creation where cus_status IN(1,10,11,12) and cus_data = 'New' ";
        ...
        $tot_existing = "SELECT COUNT(*) as tot_existing from request_creation where cus_status IN(1, 10, 11, 12) and cus_data = 'Existing' ";
