...
//     $res1 = $con->query($Qry) or die("Error in Get All Records");
...
$Qry = $con->query("SELECT * from loan_calculation where status=0 Group By loan_category");
$i=0;
...
foreach($loan_category as $cat ){
    ...
    $result=$con->query("SELECT * FROM loan_category_creation where loan_category_creation_id = '".$cat."' and status=0");
